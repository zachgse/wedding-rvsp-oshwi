...
export default function Rvsp() {
    return (
        <section className="relative min-h-screen overflow-hidden px-12">
            <Image src="/assets/bg.png" alt="bg" width={2000} height={4000} className="absolute inset-0 h-full w-full bg-local"/>

            <div className="relative z-10 min-h-screen
                            flex flex-col justify-center z-50 mx-auto gap-12 mt-24">
                <div className="relative"> 
                    <Image alt="Flower" src="/assets/flower-01.png" width={1400} height={1200} 
                    ...
                    <Image alt="Flower" src="/assets/flower-03.png" width={1400} height={1200} 
                    ...
                    <Image alt="Envelope open" src="/assets/envelope-open.png" width={3800} height={2600} 
                            className="h-auto absolute -translate-x-1/2 -rotate-10 z-40 
                            xl:w-[30%] lg:w-[40%] md:w-[50%] w-[80%] 
                            left-[36%] top-2"/> 
                    <Image alt="Envelope button" src="/assets/envelope-button.png" width={1200} height={1200} 
                            className="h-auto absolute -translate-x-1/2 -rotate-10 z-40 
                            lg:w-[10%] md:w-[15%] w-[20%] 
                            left-[37%] md:top-28 top-16"/> 
                    <Image alt="Couple pic" src="/assets/couple-pic.png" width={1500} height={1800} 
                ...
                <div className="flex items-end md:gap-8 gap-0 z-50">
                    <div className="w-1/2 flex justify-end">
                        <Image alt="RVSP image" src="/assets/click.png" width={2200} height={1700}
                            className="h-auto -rotate-15 
                                    xl:w-[40%] lg:w-[60%] md:w-[80%] w-full"/>
                    </div>
                    <div className="w-1/2 flex justify-start mb-12">
                        <Image alt="RVSP image" src="/assets/date.png" width={3400} height={4900}
